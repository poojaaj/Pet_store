            ...
            <form action="" method="POST" action="" >
                ...
                <table>
                    ...
                    <tr><td>*Last Name:</td><td><input type="text" name="l_name" > </td><td>
                            <span class="error"> <?php echo form_error('l_name'); ?></span></td></tr>
                    ...
                    <tr><td>&nbsp;Business Name:</td><td><input type="text" name="Phone"> </td></tr>
                </table>
                <br>
                <?php
                switch(@$data){
                    case 1:
                        ...
                        break;
                    case 2:
                        echo "<span style=\"color: #0F0;\">Service inserted. Email mailed to registered email.</span>";
                        break;
                    case 3:
                        echo "<span style=\"color: #F00;\">Error sending mail. Temp password is 123456</span>";
                        break;
                    case 4:
                        echo "<span style=\"color: #F00;\">Failed to insert Service</span>";
                        break;
                    case 5;
